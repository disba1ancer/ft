...
typename std::enable_if<win32::enable_enum_bitwise<Enum>::value, Enum>::type operator|(Enum enum1, Enum enum2) {
...
template <typename Enum>
typename std::enable_if<win32::enable_enum_bitwise<Enum>::value, Enum&>::type operator~(Enum& enum1) {
